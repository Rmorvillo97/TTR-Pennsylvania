/*
 ...
 DONE: Fix the take destination cards method to handle < X cards left in 
   destination deck.
 - Set up the Players
...
public class TrainGame {
    ...
    public TrainGame(String[] playerNames, TrainColor[] playerColors) {
        ...
        //add 14 wild cards
        for (int i = 0; i < 14; i++) {
            trainDeck.add(new TrainCard(TrainColor.WILD, new File("TrainColors/WILD.jpg")));
        }
        //add 12 of each color
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.YELLOW, new File("TrainColors/YELLOW.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.WHITE, new File("TrainColors/WHITE.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.RED, new File("TrainColors/RED.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.PINK, new File("TrainColors/PINK.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.ORANGE, new File("TrainColors/ORANGE.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.GREEN, new File("TrainColors/GREEN.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.BLUE, new File("TrainColors/BLUE.jpg")));
        }
        for (int i = 0; i < 12; i++) {
            trainDeck.add(new TrainCard(TrainColor.BLACK, new File("TrainColors/BLACK.jpg")));
        }
    ...
    /**
     * Main method, used solely for testing
     *
    ...
    private int longestContPath(City current, List<Route> legalRoutes){
        ...
        for (Route r: legalRoutes) {
            if(r.source.equals(current)){
                return r.length + longestContPath(r.dest, legalRoutes);
